  ...
  const projects = [
    {
      ...
      description:
        "Alyad Palyad is Marathi (Horror-Comedy) movie. I worked on this movie as a FOLEY ARTIST.",
    ...
    },
    {
      ...
      description:
        "'Maitar' is an Instagram Reel web series. I worked on this short-form series as an Assistant Recordist.",
    ...
    },
    {
      ...
      description:
        "As an assistant recordist on this devotional track dedicated to Lord Vitthal, I helped ensure the recording captured the song’s spiritual essence and melodic purity, contributing to its inspiring and uplifting quality.",
    ...
    },
    {
      ...
      description:
        "In this podcast, I worked as an assistant recordist, ensuring top-notch audio quality for engaging discussions on Morya Morya song. Their role was key in delivering a clear and professional listening experience.",
  ...
  return (
    <div className="about-wrapper">
      ...
      <div className="about-description">
        Hi, I'm Manish More. I work in the Indian film industry as a Foley
        Artist, Boom Operator, and Assistant Sound Recordist. Over the years,
        I’ve gained hands-on experience in creating detailed and immersive
        soundscapes, handling on-location sound capture, and syncing audio with
        precision in post-production. I’m well-versed with industry-standard
        equipment and workflows, and I take pride in my attention to detail and
